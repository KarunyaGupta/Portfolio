...
const ROWS = [
  [
    ...
    { title: "Databases & Tools", items: ["MySQL", "MongoDB","PowerBI","Tableau", "Excel","Power Point","Git-GitHub"] },
    { title: "Development Environment", items: ["PyCharm", "Jupyter Notebook", "Visual Studio Code", "IntelliJ IDEA"] },
  ],
  [
    { title: "Data Analysis Libraries", items: ["Pandas", "Numpy", "Matplotlib", "Seaborn","Scikit-Learn"] },
    {
      title: "Soft Skills",
