...
export default function Blog() {
  const defaultPosts = [
    ...
    },
    {
      ...
      text: "Choosing Analyst Wasn’t Just a Decision - It Was a Realization. A career should reflect your strengths, interests, and long-term goals. For me, the analyst path checked every box: curiosity, logic, communication, growth, and impact. If you’re someone who loves understanding how things work, enjoys working with data, and wants to make meaningful decisions - the analyst career is worth exploring. And trust me...Once you dive into this field, you’ll start seeing patterns everywhere."
    },
